...
Namespace Anole
    ...
    Public Class HTMLTableElement
        ...
        Public Overloads Overrides Sub Layout(renderer As HTMLRenderer, g As System.Drawing.Graphics)
    ...
    Public Class HTMLTRElement
        ...
        ''' <param name="g"></param>
        ''' <returns></returns>
        Public Function ComputeRowDimensions(ByRef nColumnWidths As Integer(), g As Graphics) As Integer
