Module Shortcuts
    ...
    Public Sub InitialiseShortcuts()
        ...
        ShortcutKeys("Revert and warn - spam") = New Shortcut(Keys.S, True, , True)
        ShortcutKeys("Revert and warn - editing tests") = New Shortcut(Keys.T, True, , True)
        ShortcutKeys("Revert and warn - removing content") = New Shortcut(Keys.D, True, , True)
        ShortcutKeys("Revert and warn - personal attacks") = New Shortcut(Keys.A, True, , True)
        ShortcutKeys("Revert and warn - factual errors") = New Shortcut(Keys.E, True, , True)
        ShortcutKeys("Revert and warn - biased content") = New Shortcut(Keys.N, True, , True)
        ShortcutKeys("Revert and warn - unsourced content") = New Shortcut(Keys.U, True, , True)
        ...
        ShortcutKeys("Warn - vandalism") = New Shortcut(Keys.W, , , True)
        ShortcutKeys("Warn - spam") = New Shortcut(Keys.S, , , True)
        ShortcutKeys("Warn - editing tests") = New Shortcut(Keys.T, , , True)
        ShortcutKeys("Warn - removing content") = New Shortcut(Keys.D, , , True)
        ShortcutKeys("Warn - personal attacks") = New Shortcut(Keys.A, , , True)
        ShortcutKeys("Warn - factual errors") = New Shortcut(Keys.E, , , True)
        ShortcutKeys("Warn - biased content") = New Shortcut(Keys.N, , , True)
        ShortcutKeys("Warn - unsourced content") = New Shortcut(Keys.U, , , True)
