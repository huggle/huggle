    ...
    public static class Languages
    {
        ...
        public static string Get(string id)
        {
            try
            {
                ...
                // return string
                if (Configuration.LanguageData.Messages.ContainsKey(Configuration.LanguageData.DefaultLanguage) != true && Configuration.LanguageData.Messages.ContainsKey(Configuration.LanguageData.Language) != true)
                {
                    return "<invalid language:" + id + ">";
                }
                if (Configuration.LanguageData.Messages[Configuration.LanguageData.Language].ContainsKey(id) == false)
                { // if there is no such a language it returns the english one
                    if (Configuration.LanguageData.Messages.ContainsKey(Configuration.LanguageData.DefaultLanguage) != true)
                    {
                        return "<not present in dict$" + id + ">";
                    }
                    if (Configuration.LanguageData.Messages[Configuration.LanguageData.DefaultLanguage].ContainsKey(id))
                    {
                        return Configuration.LanguageData.Messages[Configuration.LanguageData.DefaultLanguage][id];
                    }
                    else
                    {
                ...
                {
                    // got it
                    if (Configuration.LanguageData.Messages[Configuration.LanguageData.Language].ContainsKey(id))
                    {
                        return Configuration.LanguageData.Messages[Configuration.LanguageData.Language][id];
                    }
                    return "<invalid string:" + id + ">";
                }
            }
            ...
            {
                if (Configuration.Debugging.DevelopmentWarnings)
                {
